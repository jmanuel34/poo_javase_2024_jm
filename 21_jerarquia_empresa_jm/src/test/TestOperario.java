...
class TestOperario {
	...
	void test() {
		...
		LocalDate fecha04 = LocalDate.of(2021,10, 19);
...
//		e04.incentivar(); 
		e04.incentivar();
/*		
		assertEquals(100.0, e01.getSalario());
		assertEquals(100.0, e02.getSalario());
		assertEquals(100.0, e03.getSalario());
//*/		
		assertEquals(110.0, e04.getSalario());

//		assertEquals(120.0, e05.getSalario());
		/*		
		...
		assertEquals(100.0, e01.getSalario());
		assertEquals(100.0, e02.getSalario());
		assertEquals(110.0, e03.getSalario());	
		assertEquals(110.0, e04.getSalario());
		assertEquals(120.0, e05.getSalario());
//*/		
